...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/9313841609?text=${encodeURIComponent(text)}`;
      ...
      <div className={contactPageStyles.gridContainer}>
        <div className={contactPageStyles.formContainer}>
          ...
          <p className={contactPageStyles.formSubtitle}>
            Fill the form - we'll open the whatsapp so you can contact with us
            instantly.
          </p>
          <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
            ...
            <div className={contactPageStyles.buttonContainer}>
              <button className={contactPageStyles.button} type="submit">
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>Kathlal , Gujarat</p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> 9313841609
            </p>
            <p className={contactPageStyles.infoItem}>
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117656.99137386697!2d72.87474014506272!3d22.847591258673706!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e699d92c95683%3A0x45cef3403796ec8c!2sKathlal%20Orthopaedic%20Hospital!5e0!3m2!1sen!2sin!4v1777262039758!5m2!1sen!2sin"
