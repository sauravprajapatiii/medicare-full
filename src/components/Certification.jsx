        ...
        <div className={cs.gridContainer}>
          <div className={cs.grid}>
            {Array.from({ length: 144 }).map((_, i) => (
              <div className={cs.gridCell} key={i}></div>
            ))}
          </div>
        </div>
      </div>
      <div className={cs.contentWrapper}>
        <div className={cs.headingContainer}>
          ...
          <p className={cs.subtitle}>
            Goverment recognized and internationally accredited healthcare
            standards
          </p>
            ...
            <div className={cs.logosFlexContainer}>
              <div className={cs.logosMarquee}>
                {duplicatedCertifications.map((cert, idx) => (
                  <div key={`cert-${cert.id}-${idx}`} className={cs.logoItem}>
                    ...
                    <span className={cs.logoText}>{cert.name}</span>
                  </div>
                ))}
              </div>
            </div>
