...
import { User2, Search, Calendar, BadgeIndianRupee } from "lucide-react";
    ...
    <div className={ps.container}>
      ...
      <div className={ps.maxWidthContainer}>
        ...
        {loading ? (
          ...
          <div className={ps.noResultsContainer}>No Appointment found</div>
        ) : (
                  ...
                  <div className={ps.cardHeader}>
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <h3 className={ps.cardTitle}>{a.patientName}</h3>
                    ...
                    <div className="text-right">
                      <div className={ps.feeLabel}>Fees</div>
        ...
        {sortedFiltered.length > 0 && (
          <div className="flex justify-center mt-4">
            ...
            >
              {showAll ? "Show less" : `show less ${sortedFiltered.length - 8}`}
            </button>
          </div>
        )}
      </div>
