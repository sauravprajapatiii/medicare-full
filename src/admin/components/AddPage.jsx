...
const AddPage = () => {
  ...
  //this fncs show the imagePreview
  ...
  function addSlotToForm() {
    ...
    // if date is of today then prevent from the time
    if (slotDate === today) {
      const now = new Date();
  ...
  //it will convert schedule Object in to array
    ...
    <div className={s.pageContainer}>
      ...
      <div className={s.maxWidthContainer + " " + s.formContainer}>
        <form onSubmit={handleAdd} className={s.formGrid}>
          ...
          >
            <option disabled>Select Availablity</option>
