...
import { addServiceStyles as s } from "../dummyStyles";
import {
  AlertTriangle,
  CheckCircle,
  Clock,
...
const AddServices = ({ serviceId }) => {
  ...
  return (
    <div className={s.container.main}>
      ...
      <form className={s.container.form} onSubmit={handleSubmit}>
            ...
            >
              {submitting ? (
                ...
                <>
                  ...
                  {serviceId ? "Updated Service " : "Save Service"}
                </>
              )}
            </button>
          </div>
              ...
              <div>
                ...
                <div className={s.grids.slotsGrid}>
                  {slots.length === 0 ? (
                    ...
                    slots.map((sr, idx) => (
                      <div key={sr} className={s.slots.slotItem}>
                        <div className="flex items-center gap-2 min-w-0">
                          <Clock className={s.icon.clock} />
                          <div className={s.slots.slotText}>{sr}</div>
                        </div>
                        <button
                          type="button"
