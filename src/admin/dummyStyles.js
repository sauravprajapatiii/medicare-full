// Auto-copied from admin/src/assets/dummyStyles.js
...
export const dashboardStyles = {
  ...
  earningsHeadText: "text-sm text-right  text-slate-800",
  earningsHeadDoctor: "font-medium text-slate-600 uppercase text-xs",
...
export const navbarStyles = {
  ...
  navContainer: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3",
  ...
  logoTitle:
    "text-lg sm:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-green-600",
  logoSubtext: "text-[10px] sm:text-xs text-gray-500 leading-tight",
